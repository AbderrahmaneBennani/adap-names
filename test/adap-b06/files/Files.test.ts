...
import { Exception } from "../../../src/adap-b06/common/Exception";
import { InvalidStateException } from "../../../src/adap-b06/common/InvalidStateException";
import { ServiceFailureException } from "../../../src/adap-b06/common/ServiceFailureException";

import { StringName } from "../../../src/adap-b06/names/StringName";

import { Node } from "../../../src/adap-b06/files/Node";
import { File } from "../../../src/adap-b06/files/File";
import { BuggyFile } from "../../../src/adap-b06/files/BuggyFile";
import { Directory } from "../../../src/adap-b06/files/Directory";
import { RootNode } from "../../../src/adap-b06/files/RootNode";
...
describe("Basic naming test", () => {
  it("test name checking", () => {
    ...
    // Check equality using isEqual from Name interface (Value Object pattern)
